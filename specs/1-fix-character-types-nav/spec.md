...
**Feature Branch**: `1-fix-character-types-nav`
**Created**: 2026-02-17
**Status**: Draft
...
- Character Types are Series-scoped (per-Series). Users can import or copy Character Types from other Series via an Import UI (see below). This decision drives the UX and routing assumptions: the editor is shown in the context of a Series and must preserve `seriesId`.
