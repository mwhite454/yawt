...
| --------------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------- |
| **I. Agent-Assisted Development** | Feature leverages AI agents for implementation? Agent instructions updated in `.github/copilot-instructions.md`? | ✅ PASS / ⚠ REVIEW / ❌ FAIL |
| **II. SSR-First Architecture**    | New routes use server-side rendering? Interactive components go in `islands/`? No SPA patterns?                  | ✅ PASS / ⚠ REVIEW / ❌ FAIL |
| **III. Minimal Dependencies**     | New dependencies justified? Deno built-ins checked first? Large npm packages use dynamic imports?                | ✅ PASS / ⚠ REVIEW / ❌ FAIL |
| **IV. Mobile-First UX**           | All layouts responsive with Tailwind breakpoints? Touch targets ≥44px? Mobile input types correct?               | ✅ PASS / ⚠ REVIEW / ❌ FAIL |
| **V. Code Quality Standards**     | Code will pass `deno fmt`, `deno lint`, type checking? TypeScript used? Path aliases used?                       | ✅ PASS / ⚠ REVIEW / ❌ FAIL |
| **VI. Data Ownership & Privacy**  | User data stored with user ID prefix? No tracking/analytics added? Export capability maintained?                 | ✅ PASS / ⚠ REVIEW / ❌ FAIL |
